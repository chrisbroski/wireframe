...
* **Learning curve**: Build UIs out of HTML takes more time to learn than drawing with pencil and paper. I'd argue it takes less time than PhotoShop, but if you are already a PhotoShop guru, that's no consolation.
